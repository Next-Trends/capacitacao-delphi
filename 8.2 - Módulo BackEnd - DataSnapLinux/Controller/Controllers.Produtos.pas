...
uses
  Models.produtos, System.Generics.Collections, Types.Categoria, System.JSON;
...
function TControllerListaCompras.ToJson: TJsonArray;
begin
  Result := FListaCompras.itenstoJson;
end;

procedure TControllerListaCompras.JsonToItens(const AJsonArray: TJSONArray);
begin
  FListaCompras.JsonToItens(AJsonArray);
end;
