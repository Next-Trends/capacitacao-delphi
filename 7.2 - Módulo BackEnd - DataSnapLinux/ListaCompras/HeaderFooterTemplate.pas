...
uses
  ...
  FMX.ListView, FMX.Edit, FMX.Controls.Presentation, Controllers.Produtos, Types.Categoria,
...
begin
  FController.SalvarItensDatabaseServidor;
end;

procedure TView.btTrazerDBClick(Sender: TObject);
begin
  FController.BuscarItensDatabaseServidor;
  AtualizarView;
end;
...
begin
  ...
  Itens := FController.ObterNomesItens;

  for NomeItem in Itens do
  begin
    LListaItem := ListView1.Items.Add;
    LListaItem.Text := NomeItem;
  end;
end;
