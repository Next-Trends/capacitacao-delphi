...
uses System.Generics.Collections, Connection.Database, FireDAC.Comp.Client, Firedac.DApt, Firedac.Stan.Async, Types.Categoria, System.JSON, Rest.Types;
...
begin
  //todo: Fazer a comunicacao via RestRequest
end;
